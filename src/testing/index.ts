export { createGitStatusClientFake } from './providers/git/create-git-status-client-fake.js';
export type { GitStatusClientFake } from './providers/git/git-status-client-fake.js';
