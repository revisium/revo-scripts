...
import { validateIdempotencyKey } from '../../runtime/spec/execution/validate-idempotency-key.js';
...
export const validateRequestBeforeProviders = async <I, O, R extends ScriptResourceMap>(
  ...
  validateIdempotencyKey(script.manifest.idempotency, request.idempotencyKey);
