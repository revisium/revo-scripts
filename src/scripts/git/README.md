...
one exact positive integer revision. That pair is immutable, and every observable change increments the revision. The repository does not create physical revision directories
