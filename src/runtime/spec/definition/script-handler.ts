...
import type { RequiredIdempotencyScriptContext, ScriptContext } from './script-context.js';
...
export interface RequiredIdempotencyScriptHandler<I, O, R extends ScriptResourceMap> {
  execute(
    input: Readonly<I>,
